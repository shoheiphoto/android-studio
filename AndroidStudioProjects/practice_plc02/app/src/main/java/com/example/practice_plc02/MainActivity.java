package com.example.practice_plc02;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    /**** 各変数の宣言  ****/
    private Button openButton,closeButton,startButton,stopButton;
    ...
    /*** 演習1変更部分 ****/
    private static String CMD_M = "14010001" + "M*001000" + "0002";   // M1000とM1001まとめて
...
//  次ページへ
                ...
                case R.id.button3:  //保持開始,保持停止が押されたら
                case R.id.button4:
                    error = false;
                    if (btn.getId()== R.id.button3) {   //Button3:保持開始ボタン
                        cmd = CPUTIMER + CMD_M   + "10"; //M1000:ON,M1001:OFF
                    } else {       // Button4:保持停止
                        cmd = CPUTIMER + CMD_M + "01";//M1000:OFF, M1001:ON
                    }
